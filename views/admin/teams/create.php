        ...
        <div class="card-body">
            <form method="POST">
                ...
                <div style="margin-bottom: 16px;">
                    ...
                    <input type="text" id="short_name" name="short_name" style="width: 100%; padding: 10px; border: 1px solid var(--border); border-radius: var(--radius-md); background: var(--bg-body);" placeholder="e.g., CSK, MI">
                </div>

                <div style="margin-bottom: 24px;">
                    <label for="logo" style="display: block; margin-bottom: 8px; font-weight: 500;">Logo URL</label>
                    <input type="url" id="logo" name="logo" style="width: 100%; padding: 10px; border: 1px solid var(--border); border-radius: var(--radius-md); background: var(--bg-body);" placeholder="https://example.com/logo.png">
                </div>

                <button type="submit" class="btn btn-primary btn-lg" style="width: 100%;">Create Team</button>
            </form>
        </div>
    </div>
</div>
