<?php
/**
 * Scorer Login Page - Light Version
 * Mobile-optimized login for scorers only
 */

require_once __DIR__ . '/../includes/bootstrap.php';
require_once __DIR__ . '/../includes/session.php';

// Redirect if already logged in as scorer
    ...
    if (!empty($username) && !empty($password)) {
        ...
        if ($user) {
            ...
            if ($user['role'] === 'scorer') {
                ...
                setSession('scorer_mode', true);
                
                // Redirect to scorer dashboard
                header('Location: ' . adminUrl('scorer/index.php'));
                exit;
            } else {
                $error = 'Access denied. This login is for scorers only.';
            }
        } else {
...
<head>
    ...
    <title>Scorer Login - CricApp</title>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            <div class="login-header">
                ...
                <h1 class="login-title">Scorer Login</h1>
            ...
            <div class="login-footer">
                <a href="<?= adminUrl('login.php') ?>">Admin Login</a>
            </div>
        </div>
    </div>
</body>
