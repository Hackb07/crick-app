...
$recentMatches = $matchDataModel->getRecentMatches(50);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Recent Matches - Cricket Scoring</title>
            ...
            <?php else: ?>
                <?php foreach ($recentMatches as $matchData): ?>
                    <div class="match-card">
                        ...
                        <div class="match-date"><?= date('M d, Y', strtotime($matchData['match_date'])) ?></div>
                        <div class="match-info">
                            <a href="/cricapp/public/match-view.php?id=<?= $matchData['match_id'] ?>" class="btn btn-primary">View Details</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
